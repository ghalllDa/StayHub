        ...
        <div class="max-w-7xl mx-auto
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-4 mb-10">
                ...
                @forelse ($hotel->images as $index => $img)
                        ...
                        <img src="{{ $imgPath }}" class="rounded-2xl object-cover w-full shadow
                     {{ $index === 0 ? 'md:col-span-2 md:row-span-2 h-[420px]' : 'h-[200px]' }}"
                            alt="Foto Hotel {{ $hotel->nama_hotel }}">
                @empty
                    <img src="{{ asset('images/no-image.png') }}" class="rounded-2xl object-cover h-[420px] w-full shadow"
                        alt="Foto Hotel {{ $hotel->nama_hotel }}">
                @endforelse
            ...
            justify-between items-center">
                ...
                <a href="#kamar" class="mt-4 md:mt-0
                                    ...
                                    @if ($room->status === 'tersedia')
                                        ...
                                        hover:shadow-lg transition">
                                                    ...
                                                    <div class="w-full md:w-56 h-40">
                                                        <img src="{{ $roomImg }}" class="w-full h-40 object-cover rounded-lg"
                                                    ...
                                                    <div class="flex justify-between w-full gap-6">
                                                        ...
                                                        <div class="text-right">
                                                            ...
                                                            <a href="{{ route('booking.form', $room->id) }}" class="inline-block bg-blue-600 hover:bg-blue-700
